...
`}</style>
    ...
    <Empty >
      <EmptyHeader>
        <Inbox size={45} className=" p-2 rounded-lg h-20 w-20 dark:text-zinc-300/90 text-zinc-600"/>
        <EmptyMedia >
        </EmptyMedia>
        <EmptyTitle className={`text-xl -mt-5 dark:text-zinc-200/50 text-black`}>No notifications</EmptyTitle>
      </EmptyHeader>
