...
const Login = () => {
  ...
  return (
    ...
    <div className="flex min-h-screen flex-col ">
        ...
        <div className={`w-full flex items-center justify-center px-6 lg:px-18  overflow-hidden`}>
            ...
            <section className="flex w-full justify-center p-16 flex-2/3 ">
                ...
                className={`max-w-md w-full flex flex-col  items-center justify-center p-4 sm:p-4 rounded-xl gap-5`}>
                    ...
                    <h2 className="auth-page-title ">Sign in

                    </h2>
                    <p className="auth-page-subtitle mb-5">Welcome back! Please login to continue</p>
            ...
            className=" hidden lg:flex w-[45%]  max-w-2xl h-250 p-16  flex-1/3 overflow-hidden items-center justify-center flex-col">
                <pre className="logo-ascii-art">{readyDbugArt}</pre>
                <pre className="bug-art">{cleanedBugArt}</pre>
            </section>
