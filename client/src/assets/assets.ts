import {
  ...
  MailOpen,
  ClipboardCheck,
   Folders, Infinity, Lightbulb, Lock, Pin, Route, ScanSearch,
     ShieldUser, Sparkles,  Workflow, MessageSquareText, Paperclip, 
     BellRing, RotateCcwClock,
     Handshake,
     ChartLine,
     ClipboardClock,
     Eye,
...
import { Bug, ChartNoAxesCombined, LayoutGrid, CircleUser} from "lucide-react";
...
export const bugs = [
  {
    ...
    description:
      "Users are logged out immediately after a successful login because the issued JWT appears to expire at or shortly after creation.",
    stackTrace:
      "JsonWebTokenError: jwt expired\n    at verifyToken (src/middleware/auth.js:42:15)\n    at authenticate (src/middleware/auth.js:68:9)",
  ...
  },
  {
    ...
    description:
      "Password reset requests complete successfully, but affected users do not receive the reset email in their inbox.",
    stackTrace: null,
    project: "Authentication Service",
    severity: "high",
    status: "In Progress",
  ...
  },
  {
    ...
    description:
      "Refreshing the customer profile page causes the application to crash instead of restoring the previously loaded profile state.",
    stackTrace:
      "TypeError: Cannot read properties of undefined (reading 'name')\n    at ProfileHeader (src/components/ProfileHeader.jsx:27:18)\n    at renderWithHooks (react-dom.development.js:16305:18)",
  ...
  },
  {
    ...
    description:
      "Selected search filters are cleared when users navigate to another page and then return to the search results.",
    stackTrace: null,
    project: "Customer Portal",
    severity: "medium",
    status: "Resolved",
  ...
  },
  {
    ...
    description:
      "Retrying a failed or timed-out payment request can result in the same transaction being captured more than once.",
    stackTrace:
      "PaymentError: transaction already processed\n    at PaymentService.capture (src/services/payment.js:118:21)\n    at async PaymentService.retry (src/services/payment.js:164:7)",
  ...
  },
  {
    ...
    description:
      "Submitting a valid refund request intermittently causes the Payment Gateway API to return an HTTP 500 response.",
    stackTrace:
      "Error: Failed to create refund\n    at RefundService.create (src/services/refund.js:73:11)\n    at async POST /api/refunds (src/routes/refunds.js:41:5)",
    project: "Payment Gateway",
    severity: "high",
    status: "In Progress",
  ...
  },
  {
    ...
    description:
      "Dashboard charts remain in a loading state and fail to render when the analytics API returns a delayed or empty response.",
    stackTrace: null,
  ...
  },
  {
    ...
    description:
      "Users assigned the admin role are not receiving the expected permissions and are being denied access to restricted administrative actions.",
    stackTrace:
      "AuthorizationError: Missing permission: admin.settings\n    at authorize (src/middleware/authorize.js:56:13)\n    at processRequest (src/server/request.js:91:5)",
    project: "Admin Dashboard",
    severity: "critical",
    status: "In Review",
  ...
  },
  {
    ...
    description:
      "Inventory synchronization can incorrectly subtract stock multiple times, causing item quantities to fall below zero.",
    stackTrace:
      "InventorySyncError: Calculated quantity cannot be negative\n    at applyAdjustment (src/sync/inventory.js:102:17)\n    at syncItem (src/sync/inventory.js:141:9)",
  ...
  },
  {
    ...
    description:
      "Barcode lookup requests occasionally take longer than the configured API timeout, causing clients to receive timeout errors.",
    stackTrace: null,
    project: "Inventory API",
    severity: "low",
    status: "Resolved",
  ...
  },
  {
    ...
    description:
      "The Android app intermittently becomes unresponsive on the splash screen and never completes the startup sequence.",
    stackTrace:
      "ANR: Application Not Responding\n    at com.example.app.StartupManager.initialize(StartupManager.kt:84)\n    at com.example.app.MainActivity.onCreate(MainActivity.kt:52)",
    project: "Mobile App",
    severity: "critical",
    status: "Reopened",
    assignee: "Ava Moore",
  ...
  },
  {
    ...
    description:
      "Push notifications are being queued successfully but are delivered several minutes after the expected delivery time.",
    stackTrace: null,
  ...
  },
  {
    ...
    description:
      "Some notification events result in duplicate emails being sent to the same recipient.",
    stackTrace:
      "DuplicateEventError: Notification event processed twice\n    at NotificationWorker.process (src/workers/notification.js:88:12)\n    at async Worker.handle (src/workers/worker.js:45:5)",
    project: "Notification Service",
    severity: "low",
    status: "Open",
    assignee: "Ella Young",
  ...
  },
  {
    ...
    description:
      "Exporting analytics reports as PDF fails before the file is generated, while other export formats continue to work.",
    stackTrace:
      "PDFGenerationError: Unable to render report\n    at generatePdf (src/services/pdf.js:119:14)\n    at async exportReport (src/controllers/reports.js:76:9)",
  ...
  },
  {
    ...
    description:
      "The revenue graph displays totals that do not match the underlying transaction data, particularly for date ranges containing refunds.",
    stackTrace: null,
    project: "Analytics Platform",
    severity: "medium",
    status: "Open",
...
export const FeatureList: Array <Feature> = [
    {   id: 1,
        ...
        context:[
            {
                subtitleIcon: Lightbulb,
                subtitle: "Rich Bug Context",
                subtitleHeader: "Everything about a bug, in one place.",
                subtitleDescription: "Capture the symptoms, impact, priority, severity, attachments, discussions, and history without losing the context that matters."
            },
            {
                subtitleIcon: ClipboardList,
                subtitle: "Structured Bug Reports",
                subtitleHeader: "Turn vague reports into actionable issues.",
                subtitleDescription: "Keep every bug clear, consistent, and easy for your team to understand."
            },
            {
                subtitleIcon: Tags,
                subtitle: "Labels & Priorities",
                subtitleHeader: "Make important bugs impossible to miss.",
                subtitleDescription: "Organize issues with flexible labels, severity levels and priorities built for fast triage."
            },
        ...
        context:[
            {
                ...
                subtitleHeader: "The right access for the right people.",
                subtitleDescription: "Control what members can see and do with role-based access and custom permissions."
            },
            {
                subtitleIcon: Folders,
                subtitle: "Multi-Project Workspaces",
                subtitleHeader: "One workspace. Many projects.",
                subtitleDescription: "Keep bugs organized across products, teams, repositories or services."
            },
            {
                subtitleIcon: Infinity,
                subtitle: "Unlimited Members",
                subtitleHeader: "Bring everyone into the loop.",
                subtitleDescription: "Give engineering, QA, product and support teams one shared place to collaborate."
            },
        ...
        context:[
            {
                ...
                subtitle: "Advanced Triage",
                subtitleHeader: "Know what needs attention next.",
                subtitleDescription: "Quickly prioritize, assign, categorize and move bugs through your team's workflow."
            },
            {
                subtitleIcon: ScanSearch,
                subtitle: "Advanced Search",
                subtitleHeader: "Find the bug you're looking for.",
                subtitleDescription: "Search and filter across projects, status, priority, severity, labels, assignees and more."
            },
            {
                subtitleIcon: Workflow,
                subtitle: "Custom Workflows",
                subtitleHeader: "Make the workflow fit your team.",
                subtitleDescription: "Define statuses and stages that match the way your team investigates and resolves bugs."
            },
            {
                subtitleIcon: Pin,
                subtitle: "Saved Views",
                subtitleHeader: "Keep your most important bugs one click away.",
                subtitleDescription: "Create focused views for critical issues, assigned bugs, verification queues and anything else your team tracks regularly."
            },
    ...
    {   id: 4,
        ...
        context:[
            {
                subtitleIcon: MessageSquareText ,
                subtitle: "Comments & Mentions",
                subtitleHeader: "Discuss bugs where the context lives.",
                subtitleDescription: "Share findings, ask questions, and bring teammates into the conversation with mentions."
            },
            {
                subtitleIcon: Users,
                subtitle: "Team Activity",
                subtitleHeader: "Know what's changing across your workspace.",
                subtitleDescription: "Get a clear view of assignments, updates, status changes and team activity."
            },
            {
                subtitleIcon: BellRing,
                subtitle: "Smart Notifications",
                subtitleHeader: "Stay informed without the noise.",
                subtitleDescription: "Get notified about the changes that actually need your attention."
            },
            {
                subtitleIcon: Paperclip,
                subtitle: "File Attachments",
                subtitleHeader: "Bring the evidence with the bug.",
                subtitleDescription: "Attach screenshots, logs, recordings and supporting files directly to a bug."
            },
    ...
    {   id: 5,
        ...
        context:[
            {
                subtitleIcon: ChartLine  ,
                subtitle: "Analytics & Insights",
                subtitleHeader: "See the bigger picture.",
                subtitleDescription: "Understand bug volume, severity, priorities, trends and team activity across your workspace."
            },
            {
                subtitleIcon: RotateCcwClock,
                subtitle: "Activity History",
                subtitleHeader: "Nothing gets lost.",
                subtitleDescription: "Follow the complete timeline of a bug and see exactly how it evolved."
            },
            {
                subtitleIcon: ClipboardClock,
                subtitle: "Audit Logs",
                subtitleHeader: "Know what happened and when.",
                subtitleDescription: "Keep a reliable record of important workspace and bug-related actions."
            }            
        ]
